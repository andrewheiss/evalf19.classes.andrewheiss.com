...
<span class="newthought">Evaluation research is tricky and costly.</span> If you begin an intervention or launch a study prematurely, you can waste time and money—and potentially lives. 
...
2. A CSV file of your fake data.

You[^cloud] can either run the analysis in RStudio locally on your computer (highly recommended(!!), since you won't have to worry about keeping all your work on RStudio's servers), or use an RStudio.cloud project. You can make a copy of this RStudio.cloud project—it doesn't have anything in it, but I have preinstalled all the packages we've used over the course of the semester, so you don't have to.

- [<i class="fas fa-external-link-square-alt"></i> Empty RStudio.cloud project](https://rstudio.cloud/spaces/26160/project/714408)
...
[^cloud]: {-}
  ![The cloud is someone else's computer](/images/assignment/there-is-no-cloud.png)
...
Here's an outline of what you'll need to do.^[If you did problem sets 4 and 5, you've already done a lot of this work! I don't recommend simply copying/pasting it as is into here—you'll want to polish it up a little for this final report.] You can download this as an RMarkdown file and change the text if you want. I've also included this as an RMarkdown file in the empty RStudio.cloud project.

- [<i class="fab fa-r-project"></i> `final-project-template.Rmd`](/files/final-project/final-project-template.Rmd)
...
- If you're relying on observational data, close all the backdoors, don't adjust for colliders, and make a strong argument for isolation of the causal effect in the absence of treatment/control groups
